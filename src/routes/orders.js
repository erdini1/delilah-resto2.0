...
import { validateModifyOrderStateData, validateOrderData, validateOrderDatailsData, validateOrderExistance, validateOrderNotPending, validatePaymentMethod } from "../middlewares/orders.js"

const router = express.Router()

router
    .get("/", isAuthenticated, allOrders)
    .post("/", isAuthenticated, validateOrderData, validateOrderDatailsData, validatePaymentMethod, newOrder)
